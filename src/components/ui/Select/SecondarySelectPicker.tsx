...
import styles from './SecondarySelectPicker.module.css';
import { type PickerOption } from '@/types/global';

export interface SecondaryPickerProps {
...
const SecondarySelectPicker: React.FC<SecondaryPickerProps> = ({
  options = [],
  value,
  defaultValue,
  placeholder = '선택하세요',
...
export default SecondarySelectPicker;