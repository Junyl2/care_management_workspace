  ...
  const details = [
    {
      ...
      height: isMobileScreen ? 44 : 107,
      width: isMobileScreen ? 46 : 112,
    },
    {
      ...
      height: isMobileScreen ? 48 : 107,
      width: isMobileScreen ? 39 : 107,
    },
    {
      ...
      height: isMobileScreen ? 41 : 107,
      width: isMobileScreen ? 49 : 123,
    },
    {
      ...
      height: isMobileScreen ? 44 : 107,
      width: isMobileScreen ? 43 : 109,
    },
  ];
  return (
    <div className="container flex flex-col items-center justifty-center gap-4">
      <div className={`container pb-6 ${styles.heading}`}>
        <h3 className="primary">문제 해결</h3>
        <h2>사람과 지역을 연결하는 돌봄 네트워크 구축을 통해 풀어갑니다.</h2>
      </div>
            ...
            <div className={styles.content}>
              <div>
                <Image
                  ...
                  height={list.height}
                  width={list.width}
                  className={isMobileScreen ? 'object-cover' : 'object-contain'}
                />
              </div>
