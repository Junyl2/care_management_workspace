...
const AboutHero = () => {
  ...
  return (
    <HeroWrapper
      backgroundImage={
        isMobileScreen
          ? '/assets/images/caring/caring-friend/mobile-hero.png'
          : isTabletScreen
            ? '/assets/images/caring/caring-friend/tablet-hero.png'
            : '/assets/images/caring/caring-friend/desktop-hero.png'
      }
